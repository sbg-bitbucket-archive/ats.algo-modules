 ...
 * 
 */
public class TestCricketMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new TestCricketMatchFormat();
        matchRunner = new MatchRunner("Test Cricket sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new TestCricketMatchEngine((TestCricketMatchFormat) matchFormat);
        return matchEngine;
    }
