...
public class RollerhockeyMatchResultMarkets extends MatchResultMarkets {

    RollerhockeyMatchState previousMatchState;
    RollerhockeyMatchState currentMatchState;

    @Override
    protected CheckMarketResultedOutcome checkMarketResulted(Market market, MatchState previousMatchState,
                    MatchState currentMatchState) {
        this.previousMatchState = (RollerhockeyMatchState) previousMatchState;
        this.currentMatchState = (RollerhockeyMatchState) currentMatchState;
        ...
        switch (market.getType()) {
            ...
            default:
                throw new IllegalArgumentException(
                                "Market type missing from RollerhockeyMatchResultMarkets: " + market.getType());
