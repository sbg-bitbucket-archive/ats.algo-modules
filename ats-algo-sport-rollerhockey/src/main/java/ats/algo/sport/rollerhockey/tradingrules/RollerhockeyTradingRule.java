...
public class RollerhockeyTradingRule extends SetSuspensionStatusTradingRule {
    ...
    public RollerhockeyTradingRule(String ruleName, Integer eventTier, MarketGroup marketGroup) {
    ...
    public void applyRule(AlgoMatchState matchState, Market market, CalcRequestCause priceCalcCause,
        ...
        RollerhockeyMatchState rollerhockeyMatchState = (RollerhockeyMatchState) matchState;
        int elapsedTimeInSec = rollerhockeyMatchState.getElapsedTimeSecs();
        ...
        if (rollerhockeyMatchState.preMatch()) {
            /*
            ...
            // if((marketType.equals("FT:AXB")||marketType.equals("FT:DBLC"))&&Math.abs(rollerhockeyMatchState.getGoalsA()-rollerhockeyMatchState.getGoalsB())<3)
            // {
            // return;
            // }
