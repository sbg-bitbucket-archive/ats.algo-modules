...
public class RollerhockeyMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new RollerhockeyMatchFormat();
        matchRunner = new MatchRunner(" Rollerhockey v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new RollerhockeyMatchEngine((RollerhockeyMatchFormat) matchFormat);
        return matchEngine;
    }
