...
public class MatchProbsTest {
    ...
    public void calculateFromRatingsTest() {
        ...
        assertEquals(.574, probs.getProbHomeWinsHcap(), 0.005);
    }
    ...
    // @Test
    // public void calcLineProbsTest() {
    // MethodName.print();
    // double[] probs = new double[] {0.1, 0.5, 0.3, 0.1};
    // LineProb lineProb = MatchProbs.calcLineProb(probs);
    // // System.out.println(lineProb);
    // probs = new double[] {0.1, 0.2, 0.5, 1.1};
    // lineProb = MatchProbs.calcLineProb(probs);
    // // System.out.println(lineProb);
    // }
}
