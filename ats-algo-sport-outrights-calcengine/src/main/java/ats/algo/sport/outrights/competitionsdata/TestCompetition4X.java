 ...
 *
 */
public class TestCompetition4X {
    ...
    private static Fixtures initFixtures(Teams teams) {
        ...
        fixtures.add(Fixture.generateSecondLegFixture("2019-05-01T14:30:00", FixtureType.LEAGUE_PLAYOFF_LEG2,
                        PlayoffsMgr.PLAY_OFF1_LEG2, null, null, "3v6", false, PlayoffsMgr.PLAY_OFF1_LEG1));
        fixtures.add(Fixture.generateSecondLegFixture("2019-05-01T14:30:00", FixtureType.LEAGUE_PLAYOFF_LEG2,
                        PlayoffsMgr.PLAY_OFF2_LEG2, null, null, "4v5", false, PlayoffsMgr.PLAY_OFF2_LEG1));
    ...
    public static Competition generate() {
        ...
        Competition competition = new Competition(CompetitionType.CHAMPIONSHIP_LEAGUE, "testcompetition2", 777111L,
