...
/**
 * handles those methods of the AlgoMatchState class that are not needed for competitions (which do not use
 * AlgoMatchState within MatchRunner)
 * 
 * @author gicha
 *
 */
public abstract class AbstractState extends AlgoMatchState {
    ...
    @Override
    public abstract AlgoMatchState copy();
