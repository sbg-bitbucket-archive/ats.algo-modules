...
public class AflTradingList {
    public static final String ALL_MARKET = "All_MARKET";


    public static final String[] FIRST_HALF_SUSPEND_MARKET = new String[] {};
    ...
    public static final String[] EXTRA_TIME_OPEN_MARKET = new String[] {ALL_MARKET};
