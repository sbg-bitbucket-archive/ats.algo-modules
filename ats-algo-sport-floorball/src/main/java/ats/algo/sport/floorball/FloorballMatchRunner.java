...
public class FloorballMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new FloorballMatchFormat();
        matchRunner = new MatchRunner(" Floorball sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new FloorballMatchEngine((FloorballMatchFormat) matchFormat);
        return matchEngine;
    }
