...
public class RugbyLeagueMatchFormat extends MatchFormat {
    ...
    public RugbyLeagueMatchFormat(Map<String, Object> format) {
        super(SupportedSportType.RUGBY_LEAGUE);
        applyFormat(format);
    }
    ...
    public MatchFormatOptions matchFormatOptions() {
        return new RugbyLeagueMatchFormatOptions();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RugbyLeagueMatchFormat other = (RugbyLeagueMatchFormat) obj;
    ...
    public MatchFormat generateDefaultMatchFormat() {
        return new RugbyLeagueMatchFormat();
    }
