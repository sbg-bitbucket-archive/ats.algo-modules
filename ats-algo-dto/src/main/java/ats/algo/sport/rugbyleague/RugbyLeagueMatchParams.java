...
public class RugbyLeagueMatchParams extends MatchParams {
    ...
    public RugbyLeagueMatchParams() {
        setDefaultParams();
    }

    @JsonCreator
    private RugbyLeagueMatchParams(Map<String, Object> delegate) {
        super(delegate);
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RugbyLeagueMatchParams other = (RugbyLeagueMatchParams) obj;
