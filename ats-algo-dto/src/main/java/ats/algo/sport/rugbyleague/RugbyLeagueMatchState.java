...
/**
 * MatchState class for Rugby League
 * 
 * @author
 *
 */
public class RugbyLeagueMatchState extends MatchState {
    /**
     * 
     */
    ...
    public MatchState generateSimpleMatchState() {
        RugbyLeagueSimpleMatchState simpleMatchState = new RugbyLeagueSimpleMatchState(this.preMatch(),
                        this.isMatchCompleted(), matchPeriod, elapsedTimeSecs, getPointsA(), getPointsB(),
                        pointsFirstHalfA, pointsFirstHalfB, pointsSecondHalfA, pointsSecondHalfB);
