...
public class RugbyUnionMatchIncident extends MatchIncident {

    private static final long serialVersionUID = 1L;
    private RugbyUnionMatchIncidentType incidentSubType;
    private int injuryTimeSecs;
    private FieldPositionType fieldPosition;

    public enum RugbyUnionMatchIncidentType {
        TRY,
        DROP_GOAL,
        CONVERSION_GOAL,
        CONVERSION_MISS,
    ...
    public RugbyUnionMatchIncident() {
        super();
    }

    public RugbyUnionMatchIncident(RugbyUnionMatchIncidentType incidentSubType, int elapsedTime, TeamId teamId,
                    int injuryTimeSecs) {
        super();
    ...
    public RugbyUnionMatchIncident(RugbyUnionMatchIncidentType incidentSubType, int elapsedTime,
    ...
    @Override
    public RugbyUnionMatchIncidentType getIncidentSubType() {
        return incidentSubType;
    }

    public void setIncidentSubType(RugbyUnionMatchIncidentType incidentSubType) {
        this.incidentSubType = incidentSubType;
    }
    ...
    public void set(RugbyUnionMatchIncidentType incidentSubType, int elapsedTime, TeamId teamId) {
        this.incidentSubType = incidentSubType;
