...
/**
 * MatchState class for Rugby Union
 * 
 * @author
 *
 */
public class RugbyUnionMatchState extends MatchState {
    /**
     * 
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (injuryTimeSecs != other.injuryTimeSecs)
            return false;
        // FIXME : CHECK MATCH FORMAT PARAMS
    ...
    public MatchState generateSimpleMatchState() {
        RugbyUnionSimpleMatchState simpleMatchState = new RugbyUnionSimpleMatchState(this.preMatch(),
                        this.isMatchCompleted(), matchPeriod, elapsedTimeSecs, pointsFirstHalfA, pointsFirstHalfB,
                        pointsSecondHalfA, pointsSecondHalfB);
