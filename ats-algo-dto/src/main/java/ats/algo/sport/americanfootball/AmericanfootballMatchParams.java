...
public class AmericanfootballMatchParams extends MatchParams {
    ...
    @JsonCreator
    private AmericanfootballMatchParams(Map<String, Object> delegate) {
        super(delegate);
    ...
    public void applyParams(Map<String, Object> delegate) {
        ...
        // new MatchParam(MatchParamType.BOTHCOMBINED, "scoreTotal", params.get("scoreTotal"));
        Map<String, Object> params = (Map<String, Object>) delegate.get("paramMap");
        scoreTotal = new MatchParam(MatchParamType.BOTHCOMBINED, MarketGroup.NOT_SPECIFIED, params.get("scoreTotal"));
        scoreSupremacy = new MatchParam(MatchParamType.BOTHDIFFERENCE, MarketGroup.NOT_SPECIFIED,
                        params.get("scoreSupremacy"));
        tdTotal = new MatchParam(MatchParamType.BOTHCOMBINED, MarketGroup.NOT_SPECIFIED, params.get("tdTotal"));
        tdSupremacy = new MatchParam(MatchParamType.BOTHDIFFERENCE, MarketGroup.NOT_SPECIFIED,
                        params.get("tdSupremacy"));
        updateParamMap();
    }
