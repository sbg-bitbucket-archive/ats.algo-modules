...
/*
 * This icehockey engine take input informations includes: 1.minutes of over time (sudden death implemented) 2.Settled
 * by penalty? if no penalty but over time >0, then extra overtime until game settled
 * 
 * Under other circumstance, game accept draw value
 * 
 * Penalty settle rules: 6 shoot chances, and sudden death afterwards.
 * 
 */
...
public class IcehockeyMatchFormat extends MatchFormat {
    ...
    public IcehockeyMatchFormat(Map<String, Object> format) {
        super(SupportedSportType.ICE_HOCKEY);
        applyFormat(format);
    }
    ...
    public MatchFormatOptions matchFormatOptions() {
        return new IcehockeyMatchFormatOptions();
    }

    private static final String extraTimeMinutesKey = "Length of possible extra time (0/5/20 minutes)";
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IcehockeyMatchFormat other = (IcehockeyMatchFormat) obj;
    ...
    public MatchFormat generateDefaultMatchFormat() {
        return new IcehockeyMatchFormat();
    }
