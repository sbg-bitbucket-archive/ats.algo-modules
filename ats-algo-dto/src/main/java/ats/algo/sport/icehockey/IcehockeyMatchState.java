...
/**
 * MatchState class for Icehockey
 * 
 * @author Jin
 *
 */
public class IcehockeyMatchState extends MatchState {
    ...
    public TeamId checkTeamToXGoals(int i, int periodIndex) {
        ...
        int goalsB = 0;
        TeamId team = null;
        // FIXME: only check full time goals atm
    ...
    public IcehockeySimpleMatchState generateSimpleMatchState() {
        return new IcehockeySimpleMatchState(this.preMatch(), this.isMatchCompleted(), matchPeriod, elapsedTimeSecs,
                        ...
                        goalsThirdPeriodA, goalsThirdPeriodB, minorSinBinA, majorSinBinA, minorSinBinB, majorSinBinB);
    }
}
