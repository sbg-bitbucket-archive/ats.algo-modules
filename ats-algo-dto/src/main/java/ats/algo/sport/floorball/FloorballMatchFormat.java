...
public class FloorballMatchFormat extends MatchFormat {
    ...
    public FloorballMatchFormat(Map<String, Object> format) {
        super(SupportedSportType.FLOORBALL);
        applyFormat(format);
    }
    ...
    public MatchFormatOptions matchFormatOptions() {
        return new FloorballMatchFormatOptions();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        FloorballMatchFormat other = (FloorballMatchFormat) obj;
    ...
    public MatchFormat generateDefaultMatchFormat() {
        return new FloorballMatchFormat();
    }
