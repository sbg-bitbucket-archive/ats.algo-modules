...
public class TabletennisMatchFormat extends MatchFormat {
    /**
     * 
     */
    ...
    public MatchFormatOptions matchFormatOptions() {
        return new TabletennisMatchFormatOptions();
    }

    public TabletennisMatchFormat(Map<String, Object> format) {
        super(SupportedSportType.TABLE_TENNIS);
        applyFormat(format);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TabletennisMatchFormat other = (TabletennisMatchFormat) obj;
    ...
    public MatchFormat generateDefaultMatchFormat() {
        return new TabletennisMatchFormat();
    }
