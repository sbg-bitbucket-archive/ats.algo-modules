 ...
 *
 */
public class TestCricketMatchParams extends MatchParams {
    ...
    @JsonCreator
    private TestCricketMatchParams(Map<String, Object> delegate) {
        super(delegate);
    ...
    public void applyParams(Map<String, Object> delegate2) {
        ...
        inningoneTeamARuns =
                        new MatchParam(MatchParamType.A, MarketGroup.NOT_SPECIFIED, delegate.get("inningoneTeamARuns"));
        inningoneTeamBRuns =
                        new MatchParam(MatchParamType.B, MarketGroup.NOT_SPECIFIED, delegate.get("inningoneTeamBRuns"));
        inningtwoTeamARuns =
                        new MatchParam(MatchParamType.A, MarketGroup.NOT_SPECIFIED, delegate.get("inningtwoTeamARuns"));
        inningtwoTeamBRuns =
                        new MatchParam(MatchParamType.B, MarketGroup.NOT_SPECIFIED, delegate.get("inningtwoTeamBRuns"));
        teamAPlayer1 = new MatchParam(MatchParamType.A, MarketGroup.INDIVIDUAL, delegate.get("teamAPlayer1"));
        teamAPlayer2 = new MatchParam(MatchParamType.A, MarketGroup.INDIVIDUAL, delegate.get("teamAPlayer2"));
        teamAPlayer3 = new MatchParam(MatchParamType.A, MarketGroup.INDIVIDUAL, delegate.get("teamAPlayer3"));
        teamAPlayer4 = new MatchParam(MatchParamType.A, MarketGroup.INDIVIDUAL, delegate.get("teamAPlayer4"));
        teamAPlayer5 = new MatchParam(MatchParamType.A, MarketGroup.INDIVIDUAL, delegate.get("teamAPlayer5"));
        teamAPlayer6 = new MatchParam(MatchParamType.A, MarketGroup.INDIVIDUAL, delegate.get("teamAPlayer6"));
        teamAPlayer7 = new MatchParam(MatchParamType.A, MarketGroup.INDIVIDUAL, delegate.get("teamAPlayer7"));
        teamAPlayer8 = new MatchParam(MatchParamType.A, MarketGroup.INDIVIDUAL, delegate.get("teamAPlayer8"));
        teamAPlayer9 = new MatchParam(MatchParamType.A, MarketGroup.INDIVIDUAL, delegate.get("teamAPlayer9"));
        teamAPlayer10 = new MatchParam(MatchParamType.A, MarketGroup.INDIVIDUAL, delegate.get("teamAPlayer10"));
        teamAPlayer11 = new MatchParam(MatchParamType.A, MarketGroup.INDIVIDUAL, delegate.get("teamAPlayer11"));
        teamBPlayer1 = new MatchParam(MatchParamType.B, MarketGroup.INDIVIDUAL, delegate.get("teamBPlayer1"));
        teamBPlayer2 = new MatchParam(MatchParamType.B, MarketGroup.INDIVIDUAL, delegate.get("teamBPlayer2"));
        teamBPlayer3 = new MatchParam(MatchParamType.B, MarketGroup.INDIVIDUAL, delegate.get("teamBPlayer3"));
        teamBPlayer4 = new MatchParam(MatchParamType.B, MarketGroup.INDIVIDUAL, delegate.get("teamBPlayer4"));
        teamBPlayer5 = new MatchParam(MatchParamType.B, MarketGroup.INDIVIDUAL, delegate.get("teamBPlayer5"));
        teamBPlayer6 = new MatchParam(MatchParamType.B, MarketGroup.INDIVIDUAL, delegate.get("teamBPlayer6"));
        teamBPlayer7 = new MatchParam(MatchParamType.B, MarketGroup.INDIVIDUAL, delegate.get("teamBPlayer7"));
        teamBPlayer8 = new MatchParam(MatchParamType.B, MarketGroup.INDIVIDUAL, delegate.get("teamBPlayer8"));
        teamBPlayer9 = new MatchParam(MatchParamType.B, MarketGroup.INDIVIDUAL, delegate.get("teamBPlayer9"));
        teamBPlayer10 = new MatchParam(MatchParamType.B, MarketGroup.INDIVIDUAL, delegate.get("teamBPlayer10"));
        teamBPlayer11 = new MatchParam(MatchParamType.B, MarketGroup.INDIVIDUAL, delegate.get("teamBPlayer11"));
        updateParamMap();
    }
