...
public class TestCricketSimpleMatchState extends SimpleMatchState {
    ...
    @JsonCreator
    public TestCricketSimpleMatchState(@JsonProperty("preMatch") boolean preMatch,
                    ...
                    @JsonProperty("inningA") int inningA, @JsonProperty("inningB") int inningB,
                    @JsonProperty("bat") TeamId bat)
    ...
    public TestCricketSimpleMatchState() {
        super();
        bat = TeamId.UNKNOWN;
    }
    ...
    public void setInningA(int inningA) {
        this.inningA = inningA;
    }

    public void setInningB(int inningB) {
    ...
    public int getInningA() {
        return inningA;
    }

    public int getInningB() {
        return inningB;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + inningA;
        result = prime * result + inningB;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TestCricketSimpleMatchState other = (TestCricketSimpleMatchState) obj;
        if (ball != other.ball)
            return false;
        ...
        if (extrasB != other.extrasB)
            return false;
        if (inningA != other.inningA)
            return false;
        if (inningB != other.inningB)
            return false;
