...
/**
 * MatchState class for Futsal
 * 
 * @author Jin
 * 
 */
public class FutsalMatchState extends MatchState {
    ...
    // FIXME: COMMENTED OUT FOR STARTING PERIOD NOT IN_FIRST_PERIOD
    ...
    @Override
    public FutsalSimpleMatchState generateSimpleMatchState() {
