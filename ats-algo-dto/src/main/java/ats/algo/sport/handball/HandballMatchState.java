...
import ats.algo.sport.handball.BallPosition;
import ats.algo.sport.handball.HandballMatchIncident.HandballMatchIncidentType;

/**
 * MatchState class for Handball
 * 
 * @author Jin
 * 
 */
public class HandballMatchState extends MatchState {
    /**
     * 
     */
    ...
    // FIXME: maybe delet in future, or complete prematch and between periods choices
    // public void setElapsedTimeSecs(int elapsedTimeSecs) {
    // this.elapsedTimeSecs = elapsedTimeSecs;
    ...
    //
    // if (elapsedTimeSecs == normalHalfsSecs) {
    // this.elapsedTimeThisPeriodSecs = 0;
    // matchPeriod = HandballMatchPeriod.AT_HALF_TIME;
    // }
    //
    // if (elapsedTimeSecs > normalHalfsSecs) {
    // this.elapsedTimeThisPeriodSecs -= normalHalfsSecs;
    // matchPeriod = HandballMatchPeriod.IN_SECOND_HALF;
    // }
    //
    // if (elapsedTimeSecs == 2 * normalHalfsSecs) {
    // this.elapsedTimeThisPeriodSecs = 0;
    // matchPeriod = HandballMatchPeriod.AT_FULL_TIME;
    // }
    //
    // if (elapsedTimeSecs > 2 * normalHalfsSecs + overtimeNo * extraTimeSecs) {
    // this.elapsedTimeThisPeriodSecs -= normalHalfsSecs;
    // if (goalsA != goalsB) {
    // matchPeriod = HandballMatchPeriod.MATCH_COMPLETED;
    // } else if (extraTimeSecs == 0) {
    // overtimeNo++;
