...
/*
 * current roller hockey match format
 * 
 * 2 periods each is 20 minutes ( 25 mins not included yet) 5 minutes overtime ( 2 min 30 seconds each half) shootout
 * after overtime
 * 
 * Penalties: 2 mins minor, 5 mins major, 10 mins( allows substitutions therefore not considered in odds)
 * 
 */
...
public class RollerhockeyMatchFormat extends MatchFormat {
    ...
    public RollerhockeyMatchFormat() {
        super(SupportedSportType.ROLLER_HOCKEY);
        normalTimeMinutes = 40;
        extraTimeMinutes = 5; // 5 mins for two halfs
    ...
    public RollerhockeyMatchFormat(Map<String, Object> format) {
        super(SupportedSportType.ROLLER_HOCKEY);
        applyFormat(format);
    }
    ...
    public MatchFormatOptions matchFormatOptions() {
        return new RollerhockeyMatchFormatOptions();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RollerhockeyMatchFormat other = (RollerhockeyMatchFormat) obj;
    ...
    public MatchFormat generateDefaultMatchFormat() {
        return new RollerhockeyMatchFormat();
    }
