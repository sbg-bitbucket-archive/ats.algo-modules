...
public class RollerhockeyMatchState extends MatchState {
    /**
     * MatchState class for Rollerhockey
     * 
     * @author Jin
     *
     */
    ...
    public MatchState generateSimpleMatchState() {
        return new RollerhockeySimpleMatchState(this.preMatch(), this.isMatchCompleted());
    }
}
