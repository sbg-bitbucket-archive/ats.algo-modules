...
public class FutsalMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new FutsalMatchFormat();
        matchRunner = new MatchRunner(" Futsal sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new FutsalMatchEngine((FutsalMatchFormat) matchFormat);
        return matchEngine;
    }
