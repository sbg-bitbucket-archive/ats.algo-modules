package ats.algo.sport.futsal.tradingrules;
...
public class FutsalTradingRule extends SetSuspensionStatusTradingRule {
    ...
    public FutsalTradingRule(String ruleName, Integer eventTier, MarketGroup marketGroup) {
    ...
    public void applyRule(AlgoMatchState matchState, Market market, CalcRequestCause priceCalcCause,
        ...
        FutsalMatchState futsalMatchState = (FutsalMatchState) matchState;
        int elapsedTimeInSec = futsalMatchState.getElapsedTimeSecs();
        ...
        if (futsalMatchState.preMatch()) {
            ...
            // && Math.abs(futsalMatchState.getGoalsA() - futsalMatchState.getGoalsB()) < 3) {
            // return;
            // }
