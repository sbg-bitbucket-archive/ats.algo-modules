...
public class FutsalMatchMarketsFactory extends MarketsFactory {
    ...
    public void addDerivedMarkets(Markets markets, MatchState matchState, MatchParams matchParams) {
        ...
        if (matchState.getGamePeriod().equals(GamePeriod.PREMATCH)
            ...
            // // goalsHandicap = new HandicapStatistic("FT:SPRD", "Handicap", generateMarketFT, matchSequenceId,
            // maxNoGoalsPerTeam);
            // Market ftHandicapMarket = new Market(MarketCategory.HCAP, "FT:SPRD", matchSequenceId, "Handicap");
            ...
            //
            // /// Total Goals ///////////
            // Market ftOVUNMarket = new Market(MarketCategory.OVUN, "FT:OU", matchSequenceId, "Total Goals");
