...
public class BetStarsTennisTradingRulesTestForMerge implements AlgoManagerPublishable {
    ...
    public BetStarsTennisTradingRulesTestForMerge() {
        /*
    ...
    private MarketPricesList getGameOnePriceAtStartOfMatch(boolean twoMatchWinners, boolean includeGameOne,
        ...
        marketPricesList.put("TestSource2", m2); // Might need this for trading
                                                 // rules.
