...
public class FeedStateMismatchClearingTest extends BsSimpleAlgoManagerTennisTestBase {
    ...
    public void testForClearingAlert() {
        ...
        TennisMatchStateFromFeed tennisMatchStateFromFeed1 =
                        new TennisMatchStateFromFeed(0, 0, 0, 0, 2, 0, false, TeamId.A);
        ...
        TennisMatchStateFromFeed tennisMatchStateFromFeed2 =
                        new TennisMatchStateFromFeed(0, 0, 0, 0, 2, 2, false, TeamId.A);
        ...
        assertTrue(algoManager.getEventDetails(eventId).getEventState().getMatchState().isDatafeedStateMismatch());
        ...
        // System.out.println("super.publishedMatchState.isDatafeedStateMismatch() = " + algoManager
        // .getEventDetails(eventId).getEventState().getMatchState().isDatafeedStateMismatch());
        // System.out.println("Trader alert = " + traderAlert);
         ...
         */
        TennisMatchStateFromFeed tennisMatchStateFromFeed4 =
                        new TennisMatchStateFromFeed(0, 0, 0, 0, 2, 2, false, TeamId.A);
        TennisMatchIncident tennisMatchIncident4 = getPointWonIncident(eventId, "R4", TeamId.B);
        tennisMatchIncident4.setSourceSystem("Test");
         ...
         */
        traderAlert = null;
        TennisMatchStateFromFeed tennisMatchStateFromFeed5 =
                        new TennisMatchStateFromFeed(0, 0, 0, 0, 3, 2, false, TeamId.A);
    ...
    public void testForClearingAlert2() {
        ...
        TennisMatchStateFromFeed tennisMatchStateFromFeed2 =
                        new TennisMatchStateFromFeed(0, 0, 1, 0, 1, 0, false, TeamId.A);
        TennisMatchIncident tennisMatchIncident2 = getPointWonIncident(eventId, "R2", TeamId.B);
        tennisMatchIncident2.setTennisMatchStateFromFeed(tennisMatchStateFromFeed2);
         ...
         * agreeing. Creates a cleared alert.
         */
        TennisMatchStateFromFeed tennisMatchStateFromFeed8 =
                        new TennisMatchStateFromFeed(0, 0, 1, 0, 2, 1, false, TeamId.B);
        TennisMatchIncident tennisMatchIncident8 = getPointWonIncident(eventId, "R8", TeamId.B);
        tennisMatchIncident8.setSourceSystem("Test1");
         ...
         */
        traderAlert = null;
        TennisMatchStateFromFeed tennisMatchStateFromFeed9 =
                        new TennisMatchStateFromFeed(0, 0, 1, 0, 2, 2, false, TeamId.B);
