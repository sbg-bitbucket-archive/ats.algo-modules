...
public class BsTennisTraderAlertTest extends BsSimpleAlgoManagerTennisTestBase {
    ...
    public void test() {
        ...
        TennisMatchStateFromFeed feedState = new TennisMatchStateFromFeed(1, 1, 2, 0, 2, 3, false, TeamId.A);
