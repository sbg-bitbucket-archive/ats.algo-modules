...
public class BadmintonMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new BadmintonMatchFormat();
        matchRunner = new MatchRunner(" Badminton sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new BadmintonMatchEngine((BadmintonMatchFormat) matchFormat);
        return matchEngine;
    }
