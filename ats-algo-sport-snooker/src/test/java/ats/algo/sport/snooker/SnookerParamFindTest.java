...
public class SnookerParamFindTest {
    ...
    public void test() {
        ...
        matchParams = (SnookerMatchParams) paramFinder.getMatchParams();
        // Gaussian skill = matchParams.getOnFramePctA();
        ...
        // System.out.printf("Time taken: %.1f\n", sw.getElapsedTimeSecs());
        matchParams = (SnookerMatchParams) paramFinder.getMatchParams();
        // skill = matchParams.getOnFramePctA();
        // // System.out.println(skill.getMean());
