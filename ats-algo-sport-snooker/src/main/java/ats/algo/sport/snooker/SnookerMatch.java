...
public class SnookerMatch extends MonteCarloMatch {
    ...
    class SnookerMatchFacts {
        ...
        boolean break50PlusA;
        boolean break50PlusB;
        boolean break100PlusA;
        boolean break100PlusB;
    ...
    public void playMatch() {
        ...
        double break50A = ((SnookerMatchParams) matchParams).getBreak50A().getGaussian().nextRandom();
        double break50B = ((SnookerMatchParams) matchParams).getBreak50B().getGaussian().nextRandom();
        double break100A = ((SnookerMatchParams) matchParams).getBreak100A().getGaussian().nextRandom();
        double break100B = ((SnookerMatchParams) matchParams).getBreak100B().getGaussian().nextRandom();
        ...
        do {
            ...
            double r1 = RandomNoGenerator.nextDouble();
            matchFacts.break50PlusA = r1 < break50A;
            r1 = RandomNoGenerator.nextDouble();
            matchFacts.break50PlusB = r1 < break50B;
            r1 = RandomNoGenerator.nextDouble();
            matchFacts.break100PlusA = r1 < break100A;
            r1 = RandomNoGenerator.nextDouble();
            matchFacts.break100PlusB = r1 < break100B;
            ...
            if (frameWonByA) {
                ...
                if (matchFacts.break100PlusA)
                    simulationMatchState.getFrameBreakScore()[currentFrameNo - 1].A = 100;
            } else {
                SnookerMatchIncident snookerMatchIncident = new SnookerMatchIncident();
                snookerMatchIncident.set(SnookerMatchIncidentType.FRAMEWON);
                ...
                matchEventResult = (SnookerMatchIncidentResult) simulationMatchState
                                .updateStateForIncident(snookerMatchIncident, false);
                if (matchFacts.break100PlusB)
                    simulationMatchState.getFrameBreakScore()[currentFrameNo - 1].B = 100;
            }
