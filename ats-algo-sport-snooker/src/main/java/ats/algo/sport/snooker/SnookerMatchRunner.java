...
public class SnookerMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new SnookerMatchFormat();
        matchRunner = new MatchRunner(" Snooker sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new SnookerMatchEngine((SnookerMatchFormat) matchFormat);
        return matchEngine;
    }
