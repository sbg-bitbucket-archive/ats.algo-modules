...
public class AmericanfootballMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new AmericanfootballMatchFormat();
        matchRunner = new MatchRunner(" Americanfootball sport v1.0", (MatchFormat) matchFormat,
                        () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new AmericanfootballMatchEngine((AmericanfootballMatchFormat) matchFormat);
        return matchEngine;
    }
