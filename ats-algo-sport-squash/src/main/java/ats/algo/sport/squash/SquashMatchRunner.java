...
public class SquashMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new SquashMatchFormat();
        matchRunner = new MatchRunner(" Squash sport v1.1", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new SquashMatchEngine((SquashMatchFormat) matchFormat);
        return matchEngine;
    }
