...
public class RugbyUnionMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new RugbyUnionMatchFormat();
        matchRunner = new MatchRunner(" RugbyUnion sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new RugbyUnionMatchEngine((RugbyUnionMatchFormat) matchFormat);
        return matchEngine;
    }
