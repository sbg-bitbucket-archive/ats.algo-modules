package ats.algo.sport.rugbyunion.tradingrules.ilt;
...
import ats.algo.sport.rugbyunion.tradingrules.RugbyUnionSuspendToAwaitParamFindTradingRule;
import ats.algo.sport.rugbyunion.tradingrules.RugbyUnionTradingRule;

public class IntralotRugbyUnionTradingRules extends TradingRules {
    ...
    public IntralotRugbyUnionTradingRules() {
        super();
        ...
        RugbyUnionTradingRule rugbyunionTradingRule =
                        new RugbyUnionTradingRule("Intralot Rugby Union Trading Rule", null, null);
        ...
        rugbyunionTradingRule.setAcceptedMarketsList(allTiersAcceptedMarketList);
