...
public class RugbyUnionTradingRule extends SetSuspensionStatusTradingRule {
    ...
    public RugbyUnionTradingRule(String ruleName, Integer eventTier, MarketGroup marketGroup) {
    ...
    public void applyRule(AlgoMatchState matchState, Market market, CalcRequestCause priceCalcCause,
        ...
        RugbyUnionMatchState rugbyunionMatchState = (RugbyUnionMatchState) matchState;
        int elapsedTimeInSec = rugbyunionMatchState.getElapsedTimeSecs();
        ...
        if (rugbyunionMatchState.preMatch()) {
            /*
            ...
            if ((marketType.equals("FT:AXB") || marketType.equals("FT:DBLC"))
                            && Math.abs(rugbyunionMatchState.getPointsA() - rugbyunionMatchState.getPointsB()) < 3) {
                return;
            }
