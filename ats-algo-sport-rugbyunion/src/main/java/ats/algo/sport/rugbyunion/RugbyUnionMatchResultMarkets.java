...
public class RugbyUnionMatchResultMarkets extends MatchResultMarkets {

    RugbyUnionMatchState previousMatchState;
    RugbyUnionMatchState currentMatchState;

    @Override
    protected CheckMarketResultedOutcome checkMarketResulted(Market market, MatchState previousMatchState,
                    MatchState currentMatchState) {
        this.previousMatchState = (RugbyUnionMatchState) previousMatchState;
        this.currentMatchState = (RugbyUnionMatchState) currentMatchState;
        ...
        switch (market.getType()) {
            ...
            default:
                throw new IllegalArgumentException(
                                "Market type missing from RugbyUnionMatchResultMarkets: " + market.getType());
