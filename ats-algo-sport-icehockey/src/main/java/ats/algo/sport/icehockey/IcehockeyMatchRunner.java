...
public class IcehockeyMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new IcehockeyMatchFormat();
        matchRunner = new MatchRunner(" Icehockey sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new IcehockeyMatchEngine((IcehockeyMatchFormat) matchFormat);
        return matchEngine;
    }
