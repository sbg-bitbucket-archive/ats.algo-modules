...
public class IceHockeyTradingRule extends SetSuspensionStatusTradingRule {
    ...
    public IceHockeyTradingRule(String ruleName, Integer eventTier, MarketGroup marketGroup) {
    ...
    public void applyRule(AlgoMatchState matchState, Market market, CalcRequestCause priceCalcCause,
        ...
        IcehockeyMatchState iceHockeyMatchState = (IcehockeyMatchState) matchState;
        int elapsedTimeInSec = iceHockeyMatchState.getElapsedTimeSecs();
        ...
        if (iceHockeyMatchState.preMatch()) {
            /*
