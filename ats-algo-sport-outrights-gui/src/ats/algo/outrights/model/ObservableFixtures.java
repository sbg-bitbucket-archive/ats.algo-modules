...
public class ObservableFixtures {
    ...
    public class ObservableFixture {
        ...
        private StringProperty suspend;
        ...
        public ObservableFixture(FixturesListEntry fixturesListEntry) {
            ...
            this.suspend = new SimpleStringProperty(
                            String.valueOf(fixturesListEntry.getFixture().isFixtureSuspended()));
            ...
            if (fixturesListEntry.getFixture().getStatus().equals(OutrightsFixtureStatus.PRE_MATCH))
                this.score = new SimpleStringProperty("-");
            else
                this.score = new SimpleStringProperty(String.valueOf(fixturesListEntry.getFixture().getGoalsHome())
                                + "-" + String.valueOf(fixturesListEntry.getFixture().getGoalsAway()));
        ...
        public ObservableFixture(String date, String fixtureType, String fixtureID, String status, String homeTeamID,
            ...
            if (status.equals(OutrightsFixtureStatus.PRE_MATCH.toString()))
                this.score = new SimpleStringProperty("-");
            else
                this.score = new SimpleStringProperty(String.valueOf(goalsHome + "-" + String.valueOf(goalsAway)));
        ...
        public StringProperty suspendProperty() {
            return suspend;
        }
        ...
        public FixturesListEntry getFixturesListEntry() {
            ...
            switch (fixtureType) {
                ...
                case "LEAGUE_PLAYOFF_LEG1":
                    type = FixtureType.LEAGUE_PLAYOFF_LEG1;
                    break;
            ...
            fixture.setFixtureSuspended(suspend.getValue().equals("true"));
            String[] scores = getScore().split("-");
            if (scores.length == 2) {
                fixture.setGoalsHome(Integer.valueOf(scores[0]));
                fixture.setGoalsAway(Integer.valueOf(scores[1]));
            } else {
                fixture.setGoalsHome(0);
                fixture.setGoalsAway(0);
            }
            fixture.setEventID(getEventID());
            if (getStatus().toUpperCase().equals(OutrightsFixtureStatus.PRE_MATCH.toString()))
                fixture.setStatus(OutrightsFixtureStatus.PRE_MATCH);
            if (getStatus().toUpperCase().equals(OutrightsFixtureStatus.IN_PLAY.toString()))
                fixture.setStatus(OutrightsFixtureStatus.IN_PLAY);
            if (getStatus().toUpperCase().equals(OutrightsFixtureStatus.COMPLETED.toString()))
        ...
        public String toString() {
            return "ObservableFixture [date=" + date + ", fixtureType=" + fixtureType + ", fixtureID=" + fixtureID
                            + ", status=" + status + ", homeTeamID=" + homeTeamID + ", awayTeamID=" + awayTeamID
                            + ", eventID=" + eventID + ", suspend=" + suspend + ", tag=" + tag
                            + ", playedAtNeutralGround=" + playedAtNeutralGround + ", goalsHome=" + goalsHome
                            + ", goalsAway=" + goalsAway + ", score=" + score + ", probsSourcedfromATS="
                            + probsSourcedfromATS + ", pHome=" + pHome + ", pAway=" + pAway + ", pDraw=" + pDraw
