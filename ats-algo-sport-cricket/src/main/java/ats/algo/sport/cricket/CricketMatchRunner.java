 ...
 * 
 */
public class CricketMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new CricketMatchFormat();
        matchRunner = new MatchRunner(" Cricket sport v1.1", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new CricketMatchEngine((CricketMatchFormat) matchFormat);
        return matchEngine;
    }
