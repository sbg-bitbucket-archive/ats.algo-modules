...
public class CricketMatchState extends AlgoMatchState {
    /**
     * 
     */
    ...
    public int getRuns4A() {
        return runs4A;
    }

    public void setRuns4A(int runs4a) {
        runs4A = runs4a;
    }

    public int getRuns4B() {
        return runs4B;
    }

    public void setRuns4B(int runs4b) {
        runs4B = runs4b;
    }

    public int getRuns6A() {
        return runs6A;
    }

    public void setRuns6A(int runs6a) {
        runs6A = runs6a;
    }

    public int getRuns6B() {
        return runs6B;
    }

    public void setRuns6B(int runs6b) {
        runs6B = runs6b;
    }
    ...
    public void setEqualTo(AlgoMatchState matchState) {
        ...
        this.setRuns4A(vs.getRuns4A());
        this.setRuns4B(vs.getRuns4B());
        this.setRuns6A(vs.getRuns6A());
        this.setRuns6B(vs.getRuns6B());
    ...
    private static final String po4ScoreKey = "run 4 score";
    private static final String po6ScoreKey = "run 6 score";
    ...
    public LinkedHashMap<String, String> getAsMap() {
        ...
        map.put(po4ScoreKey, String.format("%d-%d", runs4A, runs4B));
        map.put(po6ScoreKey, String.format("%d-%d", runs6A, runs6B));
    ...
    public SimpleMatchState generateSimpleMatchState() {
        CricketSimpleMatchState simpleMatchState = new CricketSimpleMatchState(preMatch(), isMatchCompleted(),
                        getBall(), getBallsA(), getBallsB(), getExtra(), getExtrasA(), getExtrasB(), getOversA(),
                        getOversB(), getRunsA(), getRunsB(), getRuns4A(), getRuns4B(), getRuns6A(), getRuns6B(),
                        getWicket(), getWicketsA(), getWicketsB(), getInning(), getBat());
