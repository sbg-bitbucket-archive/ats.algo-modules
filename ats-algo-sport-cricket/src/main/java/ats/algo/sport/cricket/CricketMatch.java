...
public class CricketMatch extends MonteCarloMatch {
    ...
    private final double[] wicketPer = {0.63, 0.182, 0.123, 0.065, 0.025, 0.005};
    ...
    public void playMatch() {
        ...
        double pa4 = ((CricketMatchParams) matchParams).getTeamARuns4Boost().nextRandom();
        double pb4 = ((CricketMatchParams) matchParams).getTeamBRuns4Boost().nextRandom();
        double pa6 = ((CricketMatchParams) matchParams).getTeamARuns6Boost().nextRandom();
        double pb6 = ((CricketMatchParams) matchParams).getTeamBRuns6Boost().nextRandom();
        if (freeHit) {
            pa = pa + 1;
            pb = pb + 1;
        }
        ...
        for (int i = 3; i <= 4; i++) {
            perA1to6[i] = perA1to6[i] + ta4;
            perA7to16[i] = perA7to16[i] + ta4;
            perA17to20[i] = perA17to20[i] + ta4;
            perB1to6[i] = perB1to6[i] + tb4;
            perB7to16[i] = perB7to16[i] + tb4;
            perB17to20[i] = perB17to20[i] + tb4;
        }
        for (int i = 5; i < per.length; i++) {
            perA1to6[i] = perA1to6[i] + ta4 + ta6;
            perA7to16[i] = perA7to16[i] + ta4 + ta6;
            perA17to20[i] = perA17to20[i] + ta4 + ta6;
            perB1to6[i] = perB1to6[i] + tb4 + tb6;
            perB7to16[i] = perB7to16[i] + tb4 + tb6;
            perB17to20[i] = perB17to20[i] + tb4 + tb6;
        }
        ...
        do {
            ...
            switch (matchEventResult.getcricketMatchIncidentResultType()) {
                ...
                case NORUNS:
                    if (serveA)
                        matchFacts.currentRunsA = matchFacts.currentRunsA == -1 ? 0 : matchFacts.currentRunsA;
                    else
                        matchFacts.currentRunsB = matchFacts.currentRunsB == -1 ? 0 : matchFacts.currentRunsB;
                    break;
                case RUN1:
                    if (serveA)
                        matchFacts.currentRunsA = matchFacts.currentRunsA == -1 ? 1 : matchFacts.currentRunsA;
                    else
                        matchFacts.currentRunsB = matchFacts.currentRunsB == -1 ? 1 : matchFacts.currentRunsB;
                    break;
                case RUN2:
                    if (serveA)
                        matchFacts.currentRunsA = matchFacts.currentRunsA == -1 ? 2 : matchFacts.currentRunsA;
                    else
                        matchFacts.currentRunsB = matchFacts.currentRunsB == -1 ? 2 : matchFacts.currentRunsB;
                    break;
                case RUN3:
                    if (serveA)
                        matchFacts.currentRunsA = matchFacts.currentRunsA == -1 ? 3 : matchFacts.currentRunsA;
                    else
                        matchFacts.currentRunsB = matchFacts.currentRunsB == -1 ? 3 : matchFacts.currentRunsB;
                    break;
                case RUN4:
                    if (serveA)
                        matchFacts.currentRunsA = matchFacts.currentRunsA == -1 ? 4 : matchFacts.currentRunsA;
                    else
                        matchFacts.currentRunsB = matchFacts.currentRunsB == -1 ? 4 : matchFacts.currentRunsB;
                    break;
                case RUN5:
                    if (serveA)
                        matchFacts.currentRunsA = matchFacts.currentRunsA == -1 ? 5 : matchFacts.currentRunsA;
                    else
                        matchFacts.currentRunsB = matchFacts.currentRunsB == -1 ? 5 : matchFacts.currentRunsB;
                    break;
                case RUN6:
                    if (serveA)
                        matchFacts.currentRunsA = matchFacts.currentRunsA == -1 ? 6 : matchFacts.currentRunsA;
                    else
                        matchFacts.currentRunsB = matchFacts.currentRunsB == -1 ? 6 : matchFacts.currentRunsB;
                    break;
                case MATCHWON:
                case DRAW:
