...
public class LoadTestSportRunner extends Application {
    ...
    public static void main(String[] args) {
        ...
        matchRunner = new MatchRunner(" Load test sport v1.1", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new LoadTestSportMatchEngine((FootballMatchFormat) matchFormat);
        return matchEngine;
    }
