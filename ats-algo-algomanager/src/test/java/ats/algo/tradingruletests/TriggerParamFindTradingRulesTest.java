...
public class TriggerParamFindTradingRulesTest extends AlgoManagerSimpleTestBase {
    ...
    public void testPF() {
        MethodName.log();
        algoManager.useTraderAlertInsteadOfParamFindAlertDisplay(true);
        ...
        MarketPricesList marketPricesList = getTestMarketPricesTest();
    ...
    private MarketPricesList getTestMarketPricesTest() {
        MarketPricesList marketPricesList = new MarketPricesList();
        ...
        b1.put("B", 3.0);
        bet365.addMarketPrice(b1);
        MarketPrice b2 = new MarketPrice("FT:OU", "Total point", MarketCategory.OVUN, "19.5");
        b2.put("Over", 1.83);
        b2.put("Under", 1.83);
        bet365.addMarketPrice(b2);
        return marketPricesList;
