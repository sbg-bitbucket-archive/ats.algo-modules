...
public class FeedStateMismatchTest extends AlgoManagerSimpleTestBase {
    ...
    public void testChampionshipTiebreakGameEnd() {
        ...
        TennisMatchStateFromFeed tennisMatchStateFromFeed = new TennisMatchStateFromFeed(1, 1, 0, 0, 4, 2, TeamId.A);
    ...
    public void testServeIssueMatchState() {
        ...
        TennisMatchStateFromFeed tennisMatchStateFromFeed = new TennisMatchStateFromFeed(1, 0, 0, 0, 0, 3, TeamId.B);
        ...
        tennisMatchStateFromFeed = new TennisMatchStateFromFeed(1, 0, 0, 1, 0, 4, TeamId.B);
    ...
    public void testTiebreakIssueMatchState() {
        ...
        TennisMatchStateFromFeed tennisMatchStateFromFeed = new TennisMatchStateFromFeed(0, 1, 6, 7, 3, 7, TeamId.B);
        TennisMatchIncident tennisMatchIncident =
                        new TennisMatchIncident(0, TennisMatchIncidentType.POINT_WON, TeamId.B);
        ...
        tennisMatchStateFromFeed = new TennisMatchStateFromFeed(0, 1, 0, 0, 1, 0, TeamId.B);
    ...
    public void testSecondSetTiebreakMismatch() {
        ...
        TennisMatchStateFromFeed tennisMatchStateFromFeed = new TennisMatchStateFromFeed(1, 0, 6, 6, 4, 6, TeamId.B);
        tennisMatchIncident = new TennisMatchIncident(0, TennisMatchIncidentType.POINT_WON, TeamId.B);
        tennisMatchIncident.setEventId(eventId);
        tennisMatchIncident.setTennisMatchStateFromFeed(tennisMatchStateFromFeed);
        algoManager.handleMatchIncident(tennisMatchIncident, true);
        ...
        tennisMatchStateFromFeed = new TennisMatchStateFromFeed(1, 1, 6, 7, 4, 7, TeamId.B);
        tennisMatchIncident = new TennisMatchIncident(0, TennisMatchIncidentType.POINT_WON, TeamId.B);
        tennisMatchIncident.setEventId(eventId);
        tennisMatchIncident.setTennisMatchStateFromFeed(tennisMatchStateFromFeed);
        algoManager.handleMatchIncident(tennisMatchIncident, true);
    ...
    public void testUndoForPPBF() {
        ...
        TennisMatchStateFromFeed tennisMatchStateFromFeed = new TennisMatchStateFromFeed(0, 0, 1, 1, 0, 1, TeamId.B);
        ...
        tennisMatchStateFromFeed = new TennisMatchStateFromFeed(0, 0, 1, 1, 0, 2, TeamId.B);
    ...
    public void testChampionshipTieBreak() {
        ...
        // FIXME - this incident takes the game out of sync.
        ...
        TennisMatchStateFromFeed tennisMatchStateFromFeed = new TennisMatchStateFromFeed(1, 1, 6, 4, 4, 3, TeamId.B);
    ...
    public void testEndMatch2() {
        ...
        assertFalse(super.publishedMatchState.isDatafeedStateMismatch());
        TennisMatchStateFromFeed tennisMatchStateFromFeed = new TennisMatchStateFromFeed(0, 0, 5, 6, 0, 0, TeamId.A);
         ...
         */
        tennisMatchStateFromFeed = new TennisMatchStateFromFeed(1, 2, 6, 7, 4, 7, TeamId.B);
    ...
    public void testEndMatch() {
         ...
         * Create end match incident
         */
        tennisMatchStateFromFeed = new TennisMatchStateFromFeed(0, 2, 0, 0, 0, 0, TeamId.A);
    ...
    public void test1() {
         ...
         */
        TennisMatchStateFromFeed tennisMatchStateFromFeed = new TennisMatchStateFromFeed(0, 0, 0, 0, 2, 3, TeamId.A);
        TennisMatchIncident tennisMatchIncident1 = getPointWonIncident(eventId, "R3", TeamId.A);
        tennisMatchIncident1.setTennisMatchStateFromFeed(tennisMatchStateFromFeed);
        System.out.println(publishedMarkets);
        ...
        // FIXME: alert is also not triggered, because
        assertNull(traderAlert);
        ...
        tennisMatchIncident4.setTennisMatchStateFromFeed(new TennisMatchStateFromFeed(0, 0, 0, 1, 0, 1, TeamId.A));
        ...
        tennisMatchIncident5.setTennisMatchStateFromFeed(new TennisMatchStateFromFeed(0, 0, 0, 1, 0, 2, TeamId.A));
        ...
        tennisMatchIncident6.setTennisMatchStateFromFeed(new TennisMatchStateFromFeed(0, 0, 0, 1, 0, 3, TeamId.A));
        ...
        tennisMatchIncident7.setTennisMatchStateFromFeed(new TennisMatchStateFromFeed(0, 0, 0, 2, 0, 4, TeamId.A));
    ...
    public void test() {
        ...
        publishedMarkets = null;
        algoManager.handleMatchIncident(tennisMatchIncident1, true);
        assertTrue(super.publishedMatchState.isDatafeedStateMismatch());
        // System.out.println(traderAlert);
