...
// import ats.algo.sport.tennis.ppb.tradingrules.PpbTennisTradingRules;

/*
 * test of the multithreaded implementation - note these tests are obsolete since sharedMemory Configuration no longer
 * used for anything serious
 */
public class SharedMemoryAlgoManagerTest extends AlgoManagerSharedMemoryTestBase {

    // private Set<ResultedMarket> resultedMarketList = new HashSet<ResultedMarket>();
    //
    ...
    // MethodName.print();
    //
    // PpbTennisTradingRules tradingRules = new PpbTennisTradingRules();
    //
    ...
    // algoManager.handleNewEventCreation(SupportedSportType.TENNIS, eventId, tennisMatchFormat1);
    //
    // TennisMatchParams tennisMatchParams = (TennisMatchParams) algoManager.getEventDetails(eventId).getEventState()
    // .getMatchParams().generateXxxMatchParams();
    // tennisMatchParams.setEventId(eventId);
    // tennisMatchParams.getOnServePctA1().setMean(0.66);
    ...
    // abandonMatchIncident.setIncidentSubType(AbandonMatchIncidentType.WALKOVER);
    // abandonMatchIncident.setEventId(eventId);
    // abandonMatchIncident.setTeamId(TeamId.A);
    // abandonMatchIncident.setIncidentId("Abandon1");
    //
    // AbandonMatchIncident abandonMatchIncident1 = new AbandonMatchIncident();
    // abandonMatchIncident1.setIncidentSubType(AbandonMatchIncidentType.RETIREMENT);
    // abandonMatchIncident1.setEventId(eventId);
    // abandonMatchIncident1.setTeamId(TeamId.A);
    // abandonMatchIncident1.setIncidentId("Abandon2");
    //
    // algoManager.handleMatchIncident(abandonMatchIncident, true);
    //
    // algoManager.handleMatchIncident(abandonMatchIncident1, true);
    //
    // Sleep.sleep(3);
    // // System.out.println(resultedMarketList);
    // boolean marketVoid = false;
    // for (ResultedMarket rm : resultedMarketList) {
    // if (rm.getType().contains("FT:ML")) {
    // marketVoid = true;
    // }
    // }
    //
    // assertTrue(marketVoid);
    // }
    //
    // @Test
    // public void test() {
    ...
    // for (ResultedMarket market : resultedMarkets) {
    // resultedMarketList.add(market);
    // }
    // }
    //
    // @Override
