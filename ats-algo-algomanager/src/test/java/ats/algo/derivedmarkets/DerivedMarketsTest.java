...
public class DerivedMarketsTest extends AlgoManagerSimpleTestBase {
    ...
    public void testAflDerivedMarkets() {
        ...
        // algoManager.setTradingRules(SupportedSportType.AUSSIE_RULES, derivedMarketTradingRules());
    ...
    public void testMarketMetaData() {
        ...
        System.out.println(marketsMetaData.getBalancedLineForType("FT:SPRD"));
        assertTrue(marketsMetaData.getBalancedLineForType("FT:SPRD").equals("-1.5"));
    ...
    public void testResultedDerivedMarketsForCompleteMatch() {
        ...
        for (String fullKey : collectMarkets.getAllMarketKeys()) {
            /*
             * exclude first setWinner markets - incorrectlyly identified as matchWinner
             */
            if (fullKey.contains("_M") && !fullKey.contains("FT:W1S")) {
                System.out.println(fullKey);
                assertTrue(publishedResultedMarkets.getResultedMarkets().get(fullKey) == null);
            }
        }
        ...
        // assertEquals("BH", resultedMarkets.get("FT:SPRD#8.5_M").getWinningSelections().get(0));
