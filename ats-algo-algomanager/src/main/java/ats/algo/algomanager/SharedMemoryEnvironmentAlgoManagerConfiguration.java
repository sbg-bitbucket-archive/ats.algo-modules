...
public class SharedMemoryEnvironmentAlgoManagerConfiguration extends AlgoManagerConfiguration {
        ...
        public void run() {
            while (!stopRunning) {
                ...
                synchronized (algoCalculators) {
                    ...
                    AlgoMatchParams matchParams = algoCalculators[id].getUpdatedMatchParams();
        ...
        public void run() {
            while (!stopRunning) {
                ...
                synchronized (algoParamFinders) {
                    ...
                    AlgoMatchParams matchParams = algoParamFinders[id].getCalculatedMatchParams();
    ...
    class PendingPriceCalc {
        ...
        private AlgoMatchParams matchParams;
        ...
        public PendingPriceCalc(Class<? extends MatchEngine> matchEngineClass, CalcRequestCause calcRequestCause,
                        MatchFormat matchFormat, MatchState matchState, AlgoMatchParams matchParams,
        ...
        public AlgoMatchParams getMatchParams() {
            return matchParams;
        }
    ...
    class PendingParamFind {
        ...
        public PendingParamFind(Class<? extends MatchEngine> matchEngineClass, MatchFormat matchFormat,
                        MatchState matchState, AlgoMatchParams matchParams, MarketPricesList marketPricesList,
        ...
        AlgoMatchParams getMatchParams() {
            return matchParams;
        }
