...
public class SupportedSportsInitialisation {
    ...
    public static void init() {
        ...
        SupportedSports.addSport(SupportedSportType.TEST_TENNISG, "TennisG model for testing only",
                        TennisGMatchEngine.class, null);
        ...
        SupportedSports.addSport(SupportedSportType.FANTASY_EXAMPLE_SPORT, "Example of a simple fantasy sport",
                        TestSportMatchEngine.class, null);
        // SupportedSports.addSport(SupportedSportType.OUTRIGHTS, "Outrights",
        // OutrightsMatchEngine.class, null);
    }
