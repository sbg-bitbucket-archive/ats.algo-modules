...
public class RugbyLeagueMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new RugbyLeagueMatchFormat();
        matchRunner = new MatchRunner(" RugbyLeague sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new RugbyLeagueMatchEngine((RugbyLeagueMatchFormat) matchFormat);
        return matchEngine;
    }
