...
public class RugbyLeagueTradingRule extends SetSuspensionStatusTradingRule {
    ...
    public RugbyLeagueTradingRule(String ruleName, Integer eventTier, MarketGroup marketGroup) {
    ...
    public void applyRule(AlgoMatchState matchState, Market market, CalcRequestCause priceCalcCause,
        ...
        RugbyLeagueMatchState rugbyleagueMatchState = (RugbyLeagueMatchState) matchState;
        int elapsedTimeInSec = rugbyleagueMatchState.getElapsedTimeSecs();
        ...
        if (rugbyleagueMatchState.preMatch()) {
            /*
            ...
            // if ((marketType.equals("FT:AXB") || marketType.equals("FT:DBLC"))
            // && Math.abs(rugbyleagueMatchState.getPointsA() - rugbyleagueMatchState.getPointsB()) < 3) {
            // return;
            // }
