...
public class BsTennisTradingRules extends TradingRules {
    ...
    private List<String> tierOnePreMatchOpenMarketList = Arrays.asList("FT:ML", "P:ML", "FT:OU", "FT:NUMSET", "FT:CS",
            "P:OU", "P:CS", "P:SPRD", "FT:SPRD", "FT:OU:A", "FT:OU:B", "FT:TBIM", "FT:W1S:A", "FT:W1S:B");
    private List<String> tierOneInPlayDisplayMarketList = Arrays.asList("FT:ML", "P:ML", "FT:OU", "G:PW", "G:ML",
            "G:CS", "G:DEUCE", "FT:PW5G", "FT:NUMSET", "FT:CS", "P:OU", "P:CS", "P:SPRD", "FT:SPRD", "FT:OU:A", "FT:OU:B",
    ...
    private List<String> tierTwoPreMatchOpenMarketList = Arrays.asList("FT:ML", "P:ML", "FT:OU", "FT:CS", "P:CS",
            "P:OU", "FT:OU:A", "FT:OU:B", "FT:TBIM", "FT:W1S:A", "FT:W1S:B");
    private List<String> tierTwoInPlayDisplayMarketList = Arrays.asList("FT:ML", "P:ML", "FT:OU", "G:PW", "G:ML",
            "G:CS", "G:DEUCE", "FT:PW5G", "FT:CS", "P:OU", "P:CS", "FT:OU:A", "FT:OU:B", "FT:TBIM", "FT:W1S:A", "FT:W1S:B");

    /*
     * Tier 3 suspension
     */
    private List<String> tierThreePreMatchOpenMarketList = Arrays.asList("FT:ML", "P:ML", "FT:OU", "FT:CS", "FT:TBIM");
    private List<String> tierThreeInPlayDisplayMarketList = Arrays.asList("FT:ML", "P:ML", "FT:OU", "G:PW", "G:ML",
            "G:CS", "G:DEUCE", "FT:PW5G", "FT:CS", "P:OU", "P:CS", "FT:TBIM");

    /*
     * Tier 4 suspension
     */
    private List<String> tierFourPreMatchOpenMarketList = Arrays.asList("FT:ML", "P:ML", "FT:CS");
    private List<String> tierFourInPlayDisplayMarketList = Arrays.asList("FT:ML", "P:ML", "G:PW", "G:ML", "G:CS",
            "G:DEUCE", "FT:PW5G", "FT:CS", "P:CS");
    ...
    private List<String> tierSixInPlayDisplayMarketList = Arrays.asList("FT:ML", "P:ML", "G:PW", "G:ML", "G:CS", "FT:CS");

    /*
     * Tier 7 suspension
     */
    private List<String> tierSevenPreMatchOpenMarketList = Arrays.asList("FT:ML");
    private List<String> tierSevenInPlayDisplayMarketList = Arrays.asList("FT:ML");
    ...
    public BsTennisTradingRules() {
        ...
        inplaySequenceIdFiltersMapAllTiers.put("G:PW", new ArrayList<String>(Arrays.asList("S0.0.1", "S0.0.2", "S0.0.3",
                "S0.0.4", "S0.0.5")));
