...
public class PpbTennisMonitorFeedDelaySuspensionMethodHelper {
    ...
    public static class Builder {
        ...
        public PpbTennisMonitorFeedDelaySuspensionMethodHelper build() {
            return new PpbTennisMonitorFeedDelaySuspensionMethodHelper(this);
        }

    }

    private PpbTennisMonitorFeedDelaySuspensionMethodHelper(Builder builder) {
