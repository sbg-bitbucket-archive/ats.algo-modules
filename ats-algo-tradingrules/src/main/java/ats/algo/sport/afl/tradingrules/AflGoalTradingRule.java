...
public class AflGoalTradingRule extends SetSuspensionStatusTradingRule {
     ...
     * @param marketType
     */
    public AflGoalTradingRule(String ruleName, Integer eventTier, MarketGroup marketGroup) {
    ...
    public void applyRule(MatchState matchState, Market market, CalcRequestCause priceCalcCause,
        ...
        int secsSinceLastGoal = aflMatchState.secsSinceLastGoal();
    ...
    public String toString() {
        return "AflGoalTradingRule [timeToSuspendFollowingGoal=" + timeToSuspendFollowingGoal + ", statusFollowingGoal="
                        + statusFollowingGoal + ", getRuleType()=" + getRuleType() + ", getRuleName()=" + getRuleName()
