...
public class BandyMatchResultMarkets extends MatchResultMarkets {

    BandyMatchState previousMatchState;
    BandyMatchState currentMatchState;

    @Override
    protected CheckMarketResultedOutcome checkMarketResulted(Market market, MatchState previousMatchState,
                    MatchState currentMatchState) {
        this.previousMatchState = (BandyMatchState) previousMatchState;
        this.currentMatchState = (BandyMatchState) currentMatchState;
        ...
        switch (market.getType()) {
            ...
            default:
                throw new IllegalArgumentException(
                                "Market type missing from BandyMatchResultMarkets: " + market.getType());
