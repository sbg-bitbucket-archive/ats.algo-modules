...
public class BandyMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new BandyMatchFormat();
        matchRunner = new MatchRunner(" Bandy sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new BandyMatchEngine((BandyMatchFormat) matchFormat);
        return matchEngine;
    }
