...
public class TennisMatchEngine extends MonteCarloMatchEngine {
    ...
    @Override
    public ResultedMarkets resultMarketsForAbandonedEvent(Markets markets, AlgoMatchState mostRecentMatchState) {
    ...
    public void cleanUpMarketAwaitingResultSelections(MarketsAwaitingResult marketsAwaitingResult,
        ...
        ArrayList<String> resultedPartialWinnings = (ArrayList<String>) resultedMarket.getWinningSelections();
        ArrayList<String> resultedPartialVoideds = (ArrayList<String>) resultedMarket.getVoidedSelections();
        String baseMarketFullKey = resultedMarket.getFullKey();
        if (resultedPartialLosings != null) {
        ...
        if (resultedPartialWinnings != null) {
            for (String resultedSelection : resultedPartialWinnings)
                marketsAwaitingResult.updateMarketsAwaitingResultSelections(baseMarketFullKey, resultedSelection);
        }
        if (resultedPartialVoideds != null) {
