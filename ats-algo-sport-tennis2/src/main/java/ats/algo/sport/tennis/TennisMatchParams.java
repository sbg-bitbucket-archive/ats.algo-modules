...
public class TennisMatchParams extends AlgoMatchParams {
    ...
    public TennisMatchParams() {
        ...
        onServePctA1 = new MatchParam(MatchParamType.A, MarketGroup.NOT_SPECIFIED, 0.65, 0.05, 0.45, 0.99, true);
        onServePctB1 = new MatchParam(MatchParamType.B, MarketGroup.NOT_SPECIFIED, 0.65, 0.05, 0.45, 0.99, true);
        onServePctA2 = new MatchParam(MatchParamType.A, MarketGroup.NOT_SPECIFIED, 0.65, 0.05, 0.45, 0.99, true);
        onServePctB2 = new MatchParam(MatchParamType.B, MarketGroup.NOT_SPECIFIED, 0.65, 0.05, 0.45, 0.99, true);
    ...
    public void applyMomentumLogic(MatchState matchState, MatchIncidentResult matchIncidentResult,
        ...
        // /*
        // * update parameter estimate for the player currently on serve using the Bayes
        // momentum logic
        // */
        // if (onServeTeamA && onServePlayer1)
