...
class TennisMatch extends MonteCarloMatch {
    ...
    public void playMatch() {
        ...
        do {
            ...
            if (simulationMatchState.isInSuperTieBreak() && simulationMatchState.getSuperTieBreak().pointsA == 4
                            && simulationMatchState.getSuperTieBreak().pointsB == 4
                            && ((TennisMatchFormat) simulationMatchState.getMatchFormat()).getTournamentLevel()
                                            .equals(TennisMatchFormat.TournamentLevel.FAST4)) {

                // fast four death point
                double r1 = RandomNoGenerator.nextDouble(); // spin racket
                if (simulationMatchState.isDoubleMatch()) {
                    if (r1 < 0.25) {
                        simulationMatchState.setOnServeSideNow(TeamId.A);
                        simulationMatchState.setOnServePlayerTeamANow(1);
                    } else if (r1 < 0.5) {
            ...
            if (simulationMatchState.getOnServeTeamNow() == TeamId.A)
                ...
                throw new IllegalArgumentException("Tennis AlgoMatchState on server now (getOnServeNow) : "
            ...
            int currentGameA = ((TennisMatchState) simulationMatchState).getGamesA();
            int currentGameB = ((TennisMatchState) simulationMatchState).getGamesB();
            ...
            if (doubletennisMatchIncidentResult
                ...
                if (currentGameA > currentGameB && currentGameA == 2)
                    doubletennisMatchFacts.thisSetRaceToGame2 = TeamId.A;
                else if (currentGameB > currentGameA && currentGameB == 2)
                    doubletennisMatchFacts.thisSetRaceToGame2 = TeamId.B;
                else if (currentGameA > currentGameB && currentGameA == 3)
                    doubletennisMatchFacts.thisSetRaceToGame2 = TeamId.A;
                else if (currentGameB > currentGameA && currentGameB == 3)
                    doubletennisMatchFacts.thisSetRaceToGame2 = TeamId.B;
                else if (currentGameA > currentGameB && currentGameA == 4)
                    doubletennisMatchFacts.thisSetRaceToGame2 = TeamId.A;
                else if (currentGameB > currentGameA && currentGameB == 4)
                    doubletennisMatchFacts.thisSetRaceToGame2 = TeamId.B;
                else if (currentGameA > currentGameB && currentGameA == 5)
                    doubletennisMatchFacts.thisSetRaceToGame2 = TeamId.A;
                else if (currentGameB > currentGameA && currentGameB == 5)
                    doubletennisMatchFacts.thisSetRaceToGame2 = TeamId.B;
