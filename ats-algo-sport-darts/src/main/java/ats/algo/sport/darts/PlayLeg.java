...
/**
 * Simulates a single instance of a dart leg
 * 
 * @author Geoff
 * 
 */
    ...
    public LegResult play(LegState ls) {
        ...
        while (true) {
            ...
            if (tr == LegThrowResult.ISLEGWINNINGDART) {
                ...
                lr.checkoutColour = DartBoard.colourOfNumber(throwResult.getNo());
                lr.checkoutScore = cs.currentThreeDartSetScore();
                lr.NDartsThrownA = cs.playerA.getNDartsthrown();
                lr.NDartsThrownB = cs.playerB.getNDartsthrown();
                lr.N180sThrownA = cs.playerA.getN180sThrown();
                lr.N180sThrownB = cs.playerB.getN180sThrown();
                return lr;
            }
