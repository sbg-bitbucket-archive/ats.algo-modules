...
/**
 * Provides the main entry point to run the darts model within the MatchRunner model testing GUI the main entry point
...
public class DartMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        ...
        matchRunner = new MatchRunner(" Darts v2.1", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new DartMatchEngine((DartMatchFormat) matchFormat);
        return matchEngine;
    }
