...
public class DartMatchMarketsFactory extends MarketsFactory {
    ...
    // stats for both
    private TwoWayStatistic currentLegWinnerA;
    ...
    private TwoWayStatistic matchHas9DartFinish;
    ...
    private TotalStatistic currentLegNo180s;
    ...
    public DartMatchMarketsFactory(DartMatchState matchState) {
        ...
        if (setBasedMatch) {
            ...
            marketDescription = String.format("Set %d Leg %d Winner", currentSet, currentLeg);
            legSequenceId = matchState.getSequenceIdForLeg(0);
            currentLegWinnerA = new TwoWayStatistic("G:ML", marketDescription, true, legSequenceId, "A", "B");
            ...
            marketDescription = String.format("Set %d Leg %d no of 180s", currentSet, currentLeg);
            legSequenceId = matchState.getSequenceIdForLeg(0);
            currentLegNo180s = new TotalStatistic("G:OU180", marketDescription, true, legSequenceId, 6);
        ...
        } else // leg based market
        {
            ...
            marketDescription = String.format("Leg %d Winner", currentSet);
            legSequenceId = matchState.getSequenceIdForLeg(0);
            currentLegWinnerA = new TwoWayStatistic("G:ML", marketDescription, true, legSequenceId, "A", "B");
            generate = matchState.isSetMayBePlayed(currentSet + 1);
            ...
            legSequenceId = matchState.getSequenceIdForLeg(0);
            currentLegCheckoutScore = new TotalStatistic("G:OUCHK", marketDescription, true, legSequenceId, 171);
            marketDescription = String.format("Leg %d no of 180s", currentSet);
            legSequenceId = matchState.getSequenceIdForLeg(0);
            currentLegNo180s = new TotalStatistic("G:OU180", marketDescription, true, legSequenceId, 6);
        }

        matchHas9DartFinish = new TwoWayStatistic("FT:9DFN", "Match - 9-Dart finish by either player", true,
    ...
    void updateStats(DartMatchState matchState, DartMatchFacts matchFacts) {
        ...
        currentLegWinnerA.increment(matchFacts.currentLegWinner == TeamId.A);
        ...
        matchHas9DartFinish.increment(matchFacts.matchHas9DartFinish);
        ...
        currentLegNo180s.increment(matchFacts.currentLegNo180s);
