package example.algo.thirdparty.server.topicresponse;
...
public class ExampleServerUsingTopicForResponse {

    private static final Logger logger = LoggerFactory.getLogger(ExampleServerUsingTopicForResponse.class);
     ...
     */
    public ExampleServerUsingTopicForResponse(SupportedSportType sportId, String brokerUser, String brokerPassword,
                    String brokerUrl, PriceCalcResponse priceCalcResponse, ParamFindResponse paramFindResponse) {
        try {
