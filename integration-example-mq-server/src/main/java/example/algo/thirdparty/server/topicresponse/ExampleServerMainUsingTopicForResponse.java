...
import example.algo.thirdparty.server.CannedResponses;

public class ExampleServerMainUsingTopicForResponse {
    ...
    public static void main(String[] args) {
        ...
        try {
            new ExampleServerUsingTopicForResponse(supportedSportType, brokerUser, brokerPassword, brokerUrl,
                            priceCalcResponse, paramFindResponse).start();
