 ...
 * MatchFormat settings When the user Ok's the settings the "getMatchEngine" method is executed via the callback
 * provided to the MatchRunner constructor
 * 
...
public class TennisGMatchRunner extends Application {
    private static MatchRunner matchRunner;
    private static TennisGMatchFormat matchFormat;
    private static MonteCarloMatchEngine matchEngine;

    public static void main(String[] args) {
        matchFormat = new TennisGMatchFormat();
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new TennisGMatchEngine(matchFormat);
        return matchEngine;
    }
