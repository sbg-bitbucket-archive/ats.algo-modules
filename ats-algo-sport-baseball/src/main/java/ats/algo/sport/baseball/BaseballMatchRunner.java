 ...
 * 
 */
public class BaseballMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new BaseballMatchFormat();
        matchRunner = new MatchRunner(" BaseBall sport v1.1", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new BaseballMatchEngine((BaseballMatchFormat) matchFormat);
        return matchEngine;
    }
