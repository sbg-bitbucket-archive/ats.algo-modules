...
public class BowlsMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new BowlsMatchFormat();
        matchRunner = new MatchRunner(" Bowls sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new BowlsMatchEngine((BowlsMatchFormat) matchFormat);
        return matchEngine;
    }
