...
public class BeachVolleyballMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new BeachVolleyballMatchFormat();
        matchRunner = new MatchRunner(" Beach Volleyball sport v1.0", (MatchFormat) matchFormat,
                        () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new BeachVolleyballMatchEngine((BeachVolleyballMatchFormat) matchFormat);
        return matchEngine;
    }
