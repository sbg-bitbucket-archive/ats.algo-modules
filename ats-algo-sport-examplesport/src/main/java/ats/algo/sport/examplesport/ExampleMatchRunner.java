...
public class ExampleMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new ExampleMatchFormat();
        matchRunner = new MatchRunner(" Example sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new ExampleMatchEngine((ExampleMatchFormat) matchFormat);
        return matchEngine;
    }
