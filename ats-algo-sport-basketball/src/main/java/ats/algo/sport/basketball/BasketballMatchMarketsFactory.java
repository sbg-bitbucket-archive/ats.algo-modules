...
public class BasketballMatchMarketsFactory extends MarketsFactory {
    ...
    BasketballMatchMarketsFactory(BasketballMatchState matchState) {
        ...
        raceTo20Points = new ThreeWayStatistic("FT:RTC", "Race To 20 Points", MarketGroup.GOALS, false, matchSequenceId,
                        "A", "B", "Neither");

        goalsTotalOddEven = new TwoWayStatistic("FT:OE", "Total Points Odd/Even", MarketGroup.GOALS, generateMarketFT,
                        "M", "Odd", "Even");
