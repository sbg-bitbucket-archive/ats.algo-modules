...
public class BasketballMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new BasketballMatchFormat();
        matchRunner = new MatchRunner(" Basketball sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new BasketballMatchEngine((BasketballMatchFormat) matchFormat);
        return matchEngine;
    }
