...
/**
 * AlgoMatchState class for Basketball
 * 
 * @author Jin
 * 
 */
public class BasketballMatchState extends AlgoMatchState {
    ...
    private int pointsA;
    private int pointsB;
    private ArrayList<TeamId> raceTo = new ArrayList<TeamId>(
                    Arrays.asList(TeamId.UNKNOWN, TeamId.UNKNOWN, TeamId.UNKNOWN, TeamId.UNKNOWN, TeamId.UNKNOWN));
    // race to 10, 15,20, 30,50
    /*
    ...
    private int overTimePointsA = 0; // shared by two format of match
    ...
    private int overTimePointsB = 0; // shared by two format of match
    ...
    public ArrayList<TeamId> getRaceTo() {
        return raceTo;
    }

    public void setRaceTo(ArrayList<TeamId> raceTo) {
        this.raceTo = raceTo;
    }
     ...
     * 
     * @return overTimePointsA
     */
    public int getOverTimePointsA() {
        return overTimePointsA;
    }
     ...
     * 
     * @param overTimePointsA
     */
    public void setOverTimePointsA(int overTimePointsA) {
        this.overTimePointsA = overTimePointsA;
    }
     ...
     * 
     * @return overTimePointsB
     */
    public int getOverTimePointsB() {
        return overTimePointsB;
    }
     ...
     * 
     * @param overTimePointsB
     */
    public void setOverTimePointsB(int overTimePointsB) {
        this.overTimePointsB = overTimePointsB;
    }
    ...
    private void updateRacetoWinner() {
        int index = ((int) (pointsA + pointsB) / 10) - 1;
        if (index >= 0 && index < 5 && raceTo.get(index) == TeamId.UNKNOWN) {
            if (pointsA > pointsB)
                raceTo.set(index, TeamId.A);
            else if (pointsA < pointsB)
                raceTo.set(index, TeamId.B);
    ...
    public void setEqualTo(AlgoMatchState matchState) {
        ...
        this.setOverTimePointsA(((BasketballMatchState) matchState).getOverTimePointsA());
        ...
        this.setOverTimePointsB(((BasketballMatchState) matchState).getOverTimePointsB());
        ...
        ArrayList<TeamId> raceToListClone = (ArrayList<TeamId>) ((BasketballMatchState) matchState).getRaceTo().clone();
        this.setRaceTo(raceToListClone);
        try {
    ...
    public LinkedHashMap<String, String> getAsMap() {
        ...
        map.put(quarterEPointsKey, String.format("%d-%d", overTimePointsA, overTimePointsB));
        return map;
    }
    ...
    public String getSequenceIdForPeriod(int periodOffSet) {
        ...
        if (matchFormat.isTwoHalvesFormat()) {
            ...
            if (matchFormat.getExtraTimeMinutes() == 0) {
                if (periodNo > 5)
                    return null;
                return String.format("Q%d", periodNo);
            } else {
                return String.format("Q%d", periodNo);
            }
        }
    ...
    public BasketballSimpleMatchState generateSimpleMatchState() {
        BasketballSimpleMatchState basketballSimpleMatchState = new BasketballSimpleMatchState(preMatch(),
                        ...
                        fourthQuarterPointsB, firstHalfPointsB, secondHalfPointsB, overTimePointsA, overTimePointsB);
    ...
    public AlgoMatchState generateMatchStateForMatchResult(MatchResultMap matchManualResult) {
        ...
        boolean twoHalvesFormat = ((BasketballMatchFormat) this.getMatchFormat()).isTwoHalvesFormat();
        int nSets;
        if (twoHalvesFormat)
            nSets = 2;
        else
        ...
        BasketballMatchState endMatchState = (BasketballMatchState) this.copy();
        if (twoHalvesFormat) {
            setScore[0] = map.get("half1Score").valueAsPairOfIntegers();
            setScore[1] = map.get("half2Score").valueAsPairOfIntegers();
            setScore[2] = map.get("overtimeScore").valueAsPairOfIntegers();
            ...
            endMatchState.setOverTimePointsA(setScore[2].A);
            endMatchState.setOverTimePointsB(setScore[2].B);
            ...
            setScore[4] = map.get("overtimeScore").valueAsPairOfIntegers();
            ...
            endMatchState.setOverTimePointsA(setScore[4].A);
            endMatchState.setOverTimePointsB(setScore[4].B);
