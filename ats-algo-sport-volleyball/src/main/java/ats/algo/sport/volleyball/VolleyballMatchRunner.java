...
public class VolleyballMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new VolleyballMatchFormat();
        matchRunner = new MatchRunner(" Volleyball sport v5.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new VolleyballMatchEngine((VolleyballMatchFormat) matchFormat);
        return matchEngine;
    }
