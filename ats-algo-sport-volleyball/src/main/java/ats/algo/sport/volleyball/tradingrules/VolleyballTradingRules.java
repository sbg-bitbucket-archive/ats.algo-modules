...
public class VolleyballTradingRules extends TradingRules {
    ...
    public VolleyballTradingRules() {
        super();
        VolleyballTradingRule volleyballTradingRule =
                        new VolleyballTradingRule("Volleyball Coral/Lad trading rules", 3, null);
        ...
        TriggerParamFindTradingRule triggerParamFindTradingRule = TriggerParamFindTradingRule
                        .generatePriceDistanceVariant("Volleyball TriggerParamFindTradingRule", null);
