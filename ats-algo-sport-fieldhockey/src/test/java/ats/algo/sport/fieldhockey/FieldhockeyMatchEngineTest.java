...
public class FieldhockeyMatchEngineTest {
    ...
    public void test() {
        ...
        assertEquals(0.45811, markets.get("FT:AXB").get("A"), 0.01);
        ...
        assertEquals(0.71773, markets.get("FT:AXB").get("A"), 0.01);
        assertEquals(0.061104, markets.get("FT:AXB").get("Draw"), 0.01);
        assertEquals(0.21509, markets.get("FT:AXB").get("B"), 0.01);
    }
}
