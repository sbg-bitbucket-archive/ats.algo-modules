...
public class FieldhockeyMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new FieldhockeyMatchFormat();
        matchRunner = new MatchRunner(" Fieldhockey sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new FieldhockeyMatchEngine((FieldhockeyMatchFormat) matchFormat);
        return matchEngine;
    }
