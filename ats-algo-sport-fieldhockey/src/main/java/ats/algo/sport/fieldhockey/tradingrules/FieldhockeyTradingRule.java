...
public class FieldhockeyTradingRule extends SetSuspensionStatusTradingRule {
    ...
    public FieldhockeyTradingRule(String ruleName, Integer eventTier, MarketGroup marketGroup) {
    ...
    public void applyRule(AlgoMatchState matchState, Market market, CalcRequestCause priceCalcCause,
        ...
        FieldhockeyMatchState fieldhockeyMatchState = (FieldhockeyMatchState) matchState;
        int elapsedTimeInSec = fieldhockeyMatchState.getElapsedTimeSecs();
        ...
        if (fieldhockeyMatchState.preMatch()) {
            /*
            ...
            // if((marketType.equals("FT:AXB")||marketType.equals("FT:DBLC"))&&Math.abs(fieldhockeyMatchState.getGoalsA()-fieldhockeyMatchState.getGoalsB())<3)
            // {
            // return;
            // }
