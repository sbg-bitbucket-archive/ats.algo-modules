...
public class FieldhockeyMatchResultMarkets extends MatchResultMarkets {

    FieldhockeyMatchState previousMatchState;
    FieldhockeyMatchState currentMatchState;

    @Override
    protected CheckMarketResultedOutcome checkMarketResulted(Market market, MatchState previousMatchState,
                    MatchState currentMatchState) {
        this.previousMatchState = (FieldhockeyMatchState) previousMatchState;
        this.currentMatchState = (FieldhockeyMatchState) currentMatchState;
        ...
        switch (market.getType()) {
            ...
            default:
                throw new IllegalArgumentException(
                                "Market type missing from FieldhockeyMatchResultMarkets: " + market.getType());
