...
public class HandballTradingRule extends SetSuspensionStatusTradingRule {
    ...
    public HandballTradingRule(String ruleName, Integer eventTier, MarketGroup marketGroup) {
    ...
    public void applyRule(AlgoMatchState matchState, Market market, CalcRequestCause priceCalcCause,
        ...
        HandballMatchState handballMatchState = (HandballMatchState) matchState;
        int elapsedTimeInSec = handballMatchState.getElapsedTimeSecs();
        ...
        if (handballMatchState.preMatch()) {
            /*
            ...
            // && Math.abs(handballMatchState.getGoalsA() - handballMatchState.getGoalsB()) < 3) {
            // return;
            // }
