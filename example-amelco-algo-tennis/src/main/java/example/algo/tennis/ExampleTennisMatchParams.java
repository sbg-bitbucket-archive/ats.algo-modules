 ...
 *
 */
public class ExampleTennisMatchParams extends MatchParams implements Serializable {
     ...
     * @param delegate
     */
    public ExampleTennisMatchParams(Map<String, Object> delegate) {
        super(delegate);
    ...
    public void applyParams(Map<String, Object> delegate) {
        ...
        onServePctA = new MatchParam(MatchParamType.A, MarketGroup.NOT_SPECIFIED, delegate2.get("onServePctA"));
        onServePctB = new MatchParam(MatchParamType.B, MarketGroup.NOT_SPECIFIED, delegate2.get("onServePctB"));
        updateParamMap();
