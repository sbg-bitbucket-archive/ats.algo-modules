...
public class TabletennisParamFindTest {
    ...
    public void test() {
        ...
        matchParams = (TabletennisMatchParams) paramFinder.getMatchParams();

        // assertEquals(0.6574, skill.getMean(), 0.01);
        /*
        ...
        // assertEquals(0.6830, skill.getMean(), 0.04);
        // assertEquals(0.6691, skill.getMean(), 0.01);
        // /*
    ...
    private MarketPrices setTestMarketPrices1(double weight) {
        ...
        MarketPrice tmtg = new MarketPrice("FT:OU", "Total points", MarketCategory.OVUN, "70.5");
        tmtg.put("Over", 1.6);
        tmtg.put("Under", 2.8);
