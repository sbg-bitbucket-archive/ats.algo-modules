...
public class TabletennisMatchMarketsFactory extends MarketsFactory {
     ...
     *
     */
    private TwoWayStatistic gameLine3;
    private TwoWayStatistic gameLine5;
    private TwoWayStatistic gameLine7;
    private TwoWayStatistic gameLine9;
    ...
    private int pointsAhead = 2;
    private boolean generateGame9 = false;
    private boolean generateGame7 = false;

    TabletennisMatchMarketsFactory(TabletennisMatchState matchState) {
        generateGame9 = ((TabletennisMatchFormat) matchState.getMatchFormat()).getnGamesInMatch() >= 9;
        generateGame7 = ((TabletennisMatchFormat) matchState.getMatchFormat()).getnGamesInMatch() >= 7;
        ...
        generateMarket = currentPointNoA < 3 - pointsAhead && currentPointNoB < 3 - pointsAhead;
        ...
        generateMarket = currentPointNoA < 5 - pointsAhead && currentPointNoB < 5 - pointsAhead;
        ...
        generateMarket = currentPointNoA < 7 - pointsAhead && currentPointNoB < 7 - pointsAhead;
        ...
        generateMarket = currentPointNoA < 9 - pointsAhead && currentPointNoB < 9 - pointsAhead;
        ...
        gameLine3 = new TwoWayStatistic("P:RT", "Race to Game 3 Winner", currentGameNo <= 3, String.format("S%d", 3),
                        "A", "B");
        gameLine5 = new TwoWayStatistic("P:RT", "Race to Game 5 Winner", currentGameNo <= 5, String.format("S%d", 5),
                        "A", "B");
        gameLine7 = new TwoWayStatistic("P:RT", "Race to Game 7 Winner", currentGameNo <= 7 && generateGame7,
                        String.format("S%d", 7), "A", "B");
        if (generateGame9)
            gameLine9 = new TwoWayStatistic("P:RT", "Race to Game 9 Winner", currentGameNo <= 9,
                            String.format("S%d", 9), "A", "B");
    ...
    void updateStats(TabletennisMatchState matchState, TabletennisMatchFacts matchFacts) {
        ...
        TeamId rt3w = matchState.getRaceToGameNWinner(3);
        TeamId rt5w = matchState.getRaceToGameNWinner(5);
        TeamId rt7w = matchState.getRaceToGameNWinner(7);
        if (generateGame9) {
            TeamId rt9w = matchState.getRaceToGameNWinner(9);
            if (rt9w != TeamId.UNKNOWN)
                gameLine9.increment(rt9w == TeamId.A);
        }

        if (rt3w != TeamId.UNKNOWN)
            gameLine3.increment(rt3w == TeamId.A);
        if (rt5w != TeamId.UNKNOWN)
            gameLine5.increment(rt5w == TeamId.A);
        if (rt7w != TeamId.UNKNOWN)
            gameLine7.increment(rt7w == TeamId.A);
