...
public class TabletennisMatchRunner extends Application {
    ...
    public static void main(String[] args) {
        matchFormat = new TabletennisMatchFormat();
        matchRunner = new MatchRunner(" Table Tennis sport v1.0", (MatchFormat) matchFormat, () -> getMatchEngine());
        launch(args);
    }
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new TabletennisMatchEngine((TabletennisMatchFormat) matchFormat);
        return matchEngine;
    }
