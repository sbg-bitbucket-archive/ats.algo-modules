...
public class ScoreInfo {
     ...
     * @param prob
     */
    ScoreInfo(String scoreStr, double prob) {
        this.prob = prob;
     ...
     * @param prob
     */
    ScoreInfo(int goalsA, int goalsB, double prob) {
        scoreA = goalsA;
        scoreB = goalsB;
        this.prob = prob;
    }

    int goalsToGoA(ScoreInfo currentScore) {
        return scoreA - currentScore.scoreA;
    }

    int goalsToGoB(ScoreInfo currentScore) {
     ...
     * @return
     */
    boolean consistentWith(ScoreInfo currentScoreInfo) {
