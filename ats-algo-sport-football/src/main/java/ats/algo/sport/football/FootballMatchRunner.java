...
import ats.algo.sport.football.gui.FootballMatchIncidentGenerator;
...
public class FootballMatchRunner extends Application {
    ...
    protected static void init(String[] args) {
        ...
        matchRunner = new MatchRunner(" Football model v2.1(BAB)", (MatchFormat) matchFormat, () -> getMatchEngine(),
                        new FootballMatchIncidentGenerator());
        matchRunner.setBabMarketActived(true);

        launch(args);
    }

    public static void main(String[] args) {
        // uncomment to run baba trading rule
        // System.setProperty("algo.soccer.tradingrules.class",
        // "ats.algo.sport.football.baba.tradingrules.BabaFootballTradingRules");
        ...
        // System.setProperty("algo.soccer.tradingrules.class",
        // "ats.algo.sport.football.ilt.tradingrules.IntralotFootballTradingRules");
    ...
    private static MatchEngine getMatchEngine() {
        matchEngine = new FootballMatchEngine((FootballMatchFormat) matchFormat);
        return matchEngine;
    }
