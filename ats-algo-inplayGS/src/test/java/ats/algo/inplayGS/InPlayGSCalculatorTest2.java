...
public class InPlayGSCalculatorTest2 {
    ...
    public void test() {
        ...
        /*
         * assertEquals(.0213, InPlayGSNext.get("Daniel Candeias").prob, 0.0005); assertEquals(31, InPlayGSNext.get(
         * "Daniel Candeias").price, 0.0005); assertEquals(.2181, InPlayGSAnytime.get("Eren Derdiyok").prob, 0.0005);
